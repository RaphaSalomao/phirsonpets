	...
	<%@ include file="/WEB-INF/views/default/header.jsp" %>
      <main>
            <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
              ...
              <div class="carousel-inner">
                <div class="carousel-item active">
                  <img src="${IMG}/carrousel/imagem1.jpg" class="d-block w-100 imagem-carousel" alt="...">
                ...
                <div class="carousel-item">
                  <img src="${IMG}/carrousel/imagem2.jpg" class="d-block w-100 imagem-carousel2" alt="...">
                    <div class="carousel-caption d-none d-md-block">
                ...
                <div class="carousel-item">
                  <img src="${IMG}/carrousel/imagem3.jpg" class="d-block w-100 imagem-carousel3" alt="...">
                    <div class="carousel-caption d-none d-md-block">
          ...
          <div class="container d-flex pt-3">
            <img src="${IMG}/logo-phirson.png" alt="Logo Phirson Pets" class="conteudoPrincipal-logo">
